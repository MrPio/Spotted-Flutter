    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.black.withOpacity(widget.post == null ? 0 : 0.1),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: CachedNetworkImage(
                      fit: BoxFit.cover,
                      imageUrl:
                          (widget.post!.location ?? Locations.ANCONA).imageUrl,
                    ),
                  ),
                  ...
                  HighlightView(
                      onTap: () => Navigator.of(context)
                          ...
                          .then((value) => widget.refreshHomeCallback())),
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style:
                                            Fonts.regular(color: Palette.white),
                                      ),
                                      SizedBox(width: 8),
                                      Icon(
